...
import static net.fabricmc.fabric.impl.client.indigo.renderer.helper.GeometryHelper.*;
...
public abstract class AoCalculator {
	...
	/** caches results of {@link #computeFace(net.minecraft.core.Direction, boolean, boolean)} for the current block. */
