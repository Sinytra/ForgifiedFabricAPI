...
class FluidItemTests {
	...
	private static void testWaterPotion() {
		...
		if (PotionUtils.getPotion(testInventory.getItem(0)) != Potions.WATER) throw new AssertionError("Expected water potion.");
		...
		PotionUtils.setPotion(testInventory.getItem(0), Potions.LUCK);
