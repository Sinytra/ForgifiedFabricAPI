...
public interface ContainerItemContext {
	 ...
	 * This matches the behavior of {@link net.minecraft.world.item.ItemUtils#createFilledResult}.
	 */
	 ...
	 * This matches the creative behavior of {@link net.minecraft.world.item.ItemUtils#createFilledResult}.
	 */
	...
	/**
	 * Try to insert items into this context, without prioritizing a specific slot, similar to {@link net.minecraft.world.entity.player.Inventory#placeItemBackInInventory}.
