...
public class LifecycleEventApiTestImpl {

    public LifecycleEventApiTestImpl() {
        if (FMLLoader.getDist() == Dist.CLIENT) {
            ClientBlockEntityLifecycleTests.onInitializeClient();
            ClientEntityLifecycleTests.onInitializeClient();
            ClientLifecycleTests.onInitializeClient();
            ClientTickTests.onInitializeClient();
        }

        ServerBlockEntityLifecycleTests.onInitialize();
        ServerEntityLifecycleTests.onInitialize();
        ServerLifecycleTests.onInitialize();
        ServerResourceReloadTests.onInitialize();
        ServerTickTests.onInitialize();
