...
/**
 * Holds events related to {@link CreativeModeTab}.
 *
 * @see FabricItemGroup
 */
public final class ItemGroupEvents {
	 ...
	 * <p/>
	 * If you know beforehand which item group you'd like to modify, use {@link #modifyEntriesEvent(CreativeModeTab)}
	 * or {@link #modifyEntriesEvent(ResourceLocation)} instead.
	 * <p/>
	 ...
	 * @return the event
	 */
	public static Event<ModifyEntries> modifyEntriesEvent(CreativeModeTab itemGroup) {
		return modifyEntriesEvent(((IdentifiableItemGroup) itemGroup).getId());
	}
	 ...
	 * @return the event
	 */
	public static Event<ModifyEntries> modifyEntriesEvent(ResourceLocation groupId) {
