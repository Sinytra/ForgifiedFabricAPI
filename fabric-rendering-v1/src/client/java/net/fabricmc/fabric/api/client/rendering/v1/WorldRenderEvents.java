...
/**
 * Mods should use these events to introduce custom rendering during {@link net.minecraft.client.renderer.LevelRenderer#renderLevel(PoseStack, float, long, boolean, Camera, GameRenderer, LightTexture, Matrix4f)} 
...
public final class WorldRenderEvents {
	 ...
	 * Use this event instead of injecting to the HEAD of {@link net.minecraft.client.renderer.LevelRenderer#renderLevel} to avoid
	 ...
	 * by targeting {@link net.minecraft.client.renderer.LevelRenderer#renderVoxelShape}.
	 */
	...
	public interface BeforeBlockOutline {
		 ...
		 * Normally equivalent to {@link net.minecraft.client.Minecraft#hitResult}. Provided for convenience.
