...
function initializeCoreMod() {
    return {
        'injectTooltipComponent': {
            'target': {
                'type': 'METHOD',
                'class': 'net.minecraft.client.gui.screens.inventory.tooltip.ClientTooltipComponent',
                'methodName': 'm_169950_',
                'methodDesc': '(Lnet/minecraft/world/inventory/tooltip/TooltipComponent;)Lnet/minecraft/client/gui/screens/inventory/tooltip/ClientTooltipComponent;'
            },
            'transformer': function (node) {
                ...
                list.add(new MethodInsnNode(Opcodes.INVOKEINTERFACE, "net/fabricmc/fabric/api/client/rendering/v1/TooltipComponentCallback", "getComponent", "(Lnet/minecraft/world/inventory/tooltip/TooltipComponent;)Lnet/minecraft/client/gui/screens/inventory/tooltip/ClientTooltipComponent;"));
