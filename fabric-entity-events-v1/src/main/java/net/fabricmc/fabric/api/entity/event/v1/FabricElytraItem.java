...
/**
 * An interface that can be implemented on an item to provide custom elytra flight when it is worn in the {@link net.minecraft.world.entity.EquipmentSlot#CHEST} slot.
 *
