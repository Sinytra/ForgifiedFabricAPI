...
public final class EntityEventTests {
	...
	public static final RegistryObject<Block> TEST_BED = BLOCKS.register("test_bed", () -> new TestBedBlock(AbstractBlock.Settings.create().strength(1, 1)));
	...
	public EntityEventTests() {
		...
		EntitySleepEvents.MODIFY_SLEEPING_DIRECTION.register((entity, sleepingPos, sleepingDirection) -> {
			return entity.getWorld().getBlockState(sleepingPos).isOf(TEST_BED.get()) ? Direction.NORTH : sleepingDirection;
		});
