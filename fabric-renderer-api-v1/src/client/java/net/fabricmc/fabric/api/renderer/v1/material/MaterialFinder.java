...
public interface MaterialFinder extends MaterialView {
	 ...
	 *
	 * <p>By default, ambient occlusion will be used if {@link net.minecraft.client.resources.model.BakedModel#useAmbientOcclusion() the model uses ambient occlusion}
	 ...
	 *
	 * <p>By default, glint will be applied in item contexts if {@link net.minecraft.world.item.ItemStack#hasFoil() the item stack has glint}.
	 * Set to {@link TriState#TRUE} or {@link TriState#FALSE} to override this behavior.
	 *
