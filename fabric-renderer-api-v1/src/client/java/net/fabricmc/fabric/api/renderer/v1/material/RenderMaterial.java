...
public interface RenderMaterial extends MaterialView {
	 ...
	 *
	 * <p>Quads using this material use {@link net.minecraft.client.renderer.ItemBlockRenderTypes#getRenderLayers(net.minecraft.world.level.block.state.BlockState)} of
