...
public interface FabricBakedModel {
	/**
	 * When true, signals renderer this producer is implemented through {@link net.minecraft.client.resources.model.BakedModel#getQuads(BlockState, net.minecraft.core.Direction, RandomSource)}.
	 ...
	 * should invoke this for all calls to {@link net.minecraft.client.renderer.block.ModelBlockRenderer#tesselateBlock(BlockAndTintGetter, net.minecraft.client.resources.model.BakedModel, BlockState, BlockPos, com.mojang.blaze3d.vertex.PoseStack, com.mojang.blaze3d.vertex.VertexConsumer, boolean, RandomSource, long, int)}
	 ...
	 *
	 * <p>Note: with {@link net.minecraft.client.resources.model.BakedModel#getQuads(BlockState, net.minecraft.core.Direction, RandomSource)}, the random
	 ...
	 */
	void emitBlockQuads(BlockAndTintGetter blockView, BlockState state, BlockPos pos, Supplier<RandomSource> randomSupplier, RenderContext context);
	 ...
	 * {@link net.minecraft.client.resources.model.BakedModel#getOverrides()} method, because this method will be called
	 * on the <em>result</em> of  {@link net.minecraft.client.resources.model.BakedModel#getOverrides}.  However, that
	 ...
	 * logic here, instead of returning every possible shape from {@link net.minecraft.client.resources.model.BakedModel#getOverrides}
