...
/**
 * Interface for {@link net.minecraft.world.level.block.entity.BlockEntity}s which provide dynamic model state data.
 *
 ...
 *
 * <p>To access the dynamic data, cast the {@link net.minecraft.world.level.BlockAndTintGetter} to {@link RenderAttachedBlockView},
