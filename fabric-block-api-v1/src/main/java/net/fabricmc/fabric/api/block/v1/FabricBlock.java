...
/**
 * General-purpose Fabric-provided extensions for {@link net.minecraft.world.level.block.Block} subclasses.
 *
...
public interface FabricBlock extends IForgeBlock {
	 ...
	 * for example by calling {@link net.minecraft.world.level.Level#sendBlockUpdated}.
	 *
