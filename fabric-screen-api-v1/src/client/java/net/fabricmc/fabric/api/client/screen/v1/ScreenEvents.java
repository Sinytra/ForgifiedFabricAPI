...
public final class ScreenEvents {
	 ...
	 * Unless the element is button, you need to call the specific {@link net.minecraft.client.gui.components.Renderable#render(PoseStack, int, int, float) render} methods in the corresponding screen events.
	 *
	...
	public interface BeforeRender {
		void beforeRender(Screen screen, PoseStack matrices, int mouseX, int mouseY, float tickDelta);
	}

	@FunctionalInterface
	public interface AfterRender {
		void afterRender(Screen screen, PoseStack matrices, int mouseX, int mouseY, float tickDelta);
	}
