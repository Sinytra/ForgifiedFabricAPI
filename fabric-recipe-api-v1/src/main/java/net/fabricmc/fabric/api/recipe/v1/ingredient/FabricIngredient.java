...
/**
 * Fabric-provided extensions for {@link net.minecraft.world.item.crafting.Ingredient}.
...
public interface FabricIngredient {
	 ...
	 *
	 * <p>If {@code false}, {@linkplain net.minecraft.world.item.crafting.Ingredient#test testing this ingredient} with an item stack must be equivalent to checking whether
	 * the item stack's item is included in the ingredient's {@linkplain net.minecraft.world.item.crafting.Ingredient#getItems() list of matching stacks}.
	 * In that case, optimized matching logic can be used, for example using {@link net.minecraft.world.item.crafting.Ingredient#getStackingIds()}.
	 *
	 * <p>If {@code true}, the ingredient must always be tested using {@link net.minecraft.world.item.crafting.Ingredient#test(net.minecraft.world.item.ItemStack)}.
