...
public final class DefaultCustomIngredients {
	 ...
	 *
	 * <p>See {@link net.minecraft.nbt.NbtUtils#compareNbt} for the non-strict matching.
	 *
	 * <p>The JSON format is as follows:
	 * <pre>{@code
	 * {
	 ...
	 */
	public static Ingredient nbt(Ingredient base, @Nullable CompoundTag nbt, boolean strict) {
		Objects.requireNonNull(base, "Base ingredient cannot be null");
	 ...
	 *
	 * @see #nbt(Ingredient, CompoundTag, boolean)
	 */
	public static Ingredient nbt(ItemStack stack, boolean strict) {
		Objects.requireNonNull(stack, "Stack cannot be null");

		return nbt(Ingredient.of(stack.getItem()), stack.getTag(), strict);
	}
