 ...
 * Not to be confused with a {@link net.minecraft.world.entity.npc.VillagerProfession}, a villager type defines the appearance of a villager.
 *
...
public final class VillagerTypeHelper {
	...
	public static void addVillagerTypeToBiome(ResourceKey<Biome> biomeKey, VillagerType villagerType) {
		...
		if (VillagerType.BY_BIOME.put(biomeKey, villagerType) != null) {
			LOGGER.debug("Overriding existing Biome -> VillagerType registration for Biome {}", biomeKey.location());
		}
	}
