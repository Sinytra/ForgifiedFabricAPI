...
public final class BlockSetTypeRegistry {
	 ...
	 */
	public static BlockSetType registerWood(ResourceLocation id) {
	 ...
	 *
	 * @param id the id of this {@link BlockSetType}
	 * @param soundType the {@link SoundType} for this block set
	 ...
	 * @return a new {@link BlockSetType}
	 */
	public static BlockSetType register(ResourceLocation id, SoundType soundType, SoundEvent doorClose, SoundEvent doorOpen, SoundEvent trapdoorClose, SoundEvent trapdoorOpen, SoundEvent pressurePlateClickOff, SoundEvent pressurePlateClickOn, SoundEvent buttonClickOff, SoundEvent buttonClickOn) {
