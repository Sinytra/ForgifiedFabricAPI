...
public final class MiningLevelTest {
	...
	public static final RegistryObject<Block> NEEDS_NETHERITE_SWORD = BLOCKS.register("needs_netherite_sword", () -> new Block(AbstractBlock.Settings.create().strength(2, 3).requiresTool()));
	...
	public static final RegistryObject<Block> NEEDS_STONE_SWORD = BLOCKS.register("needs_stone_sword", () -> new Block(AbstractBlock.Settings.create().strength(2, 3).requiresTool()));
	public static final RegistryObject<Item> NEEDS_STONE_SWORD_ITEM = blockItem(NEEDS_STONE_SWORD);
	// any sword
	public static final RegistryObject<Block> NEEDS_ANY_SWORD = BLOCKS.register("needs_any_sword", () -> new Block(AbstractBlock.Settings.create().strength(2, 3).requiresTool()));
	public static final RegistryObject<Item> NEEDS_ANY_SWORD_ITEM = blockItem(NEEDS_ANY_SWORD);
	// shears
	public static final RegistryObject<Block> NEEDS_SHEARS = BLOCKS.register("needs_shears", () -> new Block(AbstractBlock.Settings.create().strength(2, 3).requiresTool()));
	...
	public static final RegistryObject<Block> NEEDS_NETHERITE_PICKAXE = BLOCKS.register("needs_netherite_pickaxe", () -> new Block(AbstractBlock.Settings.create().strength(2, 3).requiresTool()));
	...
	public static final RegistryObject<Block> NEEDS_AXE = BLOCKS.register("needs_axe", () -> new Block(AbstractBlock.Settings.create().strength(2, 3).requiresTool()));
	public static final RegistryObject<Item> NEEDS_AXE_ITEM = blockItem(NEEDS_AXE);
	// vanilla mineable tag, requires tool (this type of block doesn't exist in vanilla)
	public static final RegistryObject<Block> NEEDS_HOE = BLOCKS.register("needs_hoe", () -> new Block(AbstractBlock.Settings.create().strength(2, 3).requiresTool()));
	public static final RegistryObject<Item> NEEDS_HOE_ITEM = blockItem(NEEDS_HOE);
	// vanilla mineable tag, requires tool (this type of block doesn't exist in vanilla)
	public static final RegistryObject<Block> NEEDS_SHOVEL = BLOCKS.register("needs_shovel", () -> new Block(AbstractBlock.Settings.create().strength(2, 3).requiresTool()));
