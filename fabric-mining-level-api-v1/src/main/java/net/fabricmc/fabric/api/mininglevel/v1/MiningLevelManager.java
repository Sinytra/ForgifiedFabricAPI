 ...
 * {@link net.minecraft.tags.BlockTags#NEEDS_STONE_TOOL #needs_stone_tool},
 * {@link net.minecraft.tags.BlockTags#NEEDS_IRON_TOOL #needs_iron_tool} and
 * {@link net.minecraft.tags.BlockTags#NEEDS_DIAMOND_TOOL #needs_diamond_tool}.
...
public final class MiningLevelManager {
	...
	public static TagKey<Block> getBlockTag(int miningLevel) {
		...
		default -> TagKey.create(Registries.BLOCK, new ResourceLocation("fabric", "needs_tool_level_" + miningLevel));
		};
	}
}
