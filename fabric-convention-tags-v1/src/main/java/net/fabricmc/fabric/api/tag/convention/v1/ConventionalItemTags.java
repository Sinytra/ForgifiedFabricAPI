...
public final class ConventionalItemTags {
	...
	/** @deprecated Replaced with {@link net.minecraft.tags.ItemTags#PICKAXES}. */
	@Deprecated(forRemoval = true)
	public static final TagKey<Item> PICKAXES = register("pickaxes");
	/** @deprecated Replaced with {@link net.minecraft.tags.ItemTags#SHOVELS}. */
	@Deprecated(forRemoval = true)
	public static final TagKey<Item> SHOVELS = register("shovels");
	/** @deprecated Replaced with {@link net.minecraft.tags.ItemTags#HOES}. */
	@Deprecated(forRemoval = true)
	public static final TagKey<Item> HOES = register("hoes");
	/** @deprecated Replaced with {@link net.minecraft.tags.ItemTags#AXES}. */
	@Deprecated(forRemoval = true)
	public static final TagKey<Item> AXES = register("axes");
	/** @deprecated Replaced with {@link net.minecraft.tags.ItemTags#SWORDS}. */
	@Deprecated(forRemoval = true)
