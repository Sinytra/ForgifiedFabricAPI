...
public class FabricApiLookupTest {
	...
	public static final RegistryObject<ChuteBlock> CHUTE_BLOCK = BLOCK_REGISTER.register("chute", () -> new ChuteBlock(FabricBlockSettings.create()));
	...
	public static final RegistryObject<CobbleGenBlock> COBBLE_GEN_BLOCK = BLOCK_REGISTER.register("cobble_gen", () -> new CobbleGenBlock(FabricBlockSettings.create()));
	...
	public static final RegistryObject<InspectorBlock> INSPECTOR_BLOCK = BLOCK_REGISTER.register("inspector", () -> new InspectorBlock(FabricBlockSettings.create()));
