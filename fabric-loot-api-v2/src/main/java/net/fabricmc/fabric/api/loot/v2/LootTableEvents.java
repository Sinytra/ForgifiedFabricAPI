...
public final class LootTableEvents {
	...
	public interface Replace {
		 ...
		 */
		@Nullable
		LootTable replaceLootTable(ResourceManager resourceManager, LootTables lootManager, ResourceLocation id, LootTable original, LootTableSource source);
	}
	...
	public interface Modify {
		 ...
		 */
		void modifyLootTable(ResourceManager resourceManager, LootTables lootManager, ResourceLocation id, LootTable.Builder tableBuilder, LootTableSource source);
	}
}
