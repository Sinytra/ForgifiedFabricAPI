...
public final class ServerLoginConnectionEvents {
	 ...
	 *
	 * @see ServerLoginNetworking#registerReceiver(ServerLoginPacketListenerImpl, net.minecraft.resources.ResourceLocation, ServerLoginNetworking.LoginQueryResponseHandler)
	 */
	 ...
	 * using {@link ServerLoginNetworking#registerReceiver(ServerLoginPacketListenerImpl, net.minecraft.resources.ResourceLocation, ServerLoginNetworking.LoginQueryResponseHandler)}
