 ...
 * which initializes the fields to be written, and one that takes a {@link FriendlyByteBuf}
 ...
 * @see ServerPlayNetworking#send(net.minecraft.server.level.ServerPlayer, PacketType, FabricPacket)
