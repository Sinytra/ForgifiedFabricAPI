...
public final class NetworkingLoginQueryTest {
	...
	public static void onInitialize() {
		ServerLoginConnectionEvents.QUERY_START.register(NetworkingLoginQueryTest::onLoginStart);
		ServerLoginConnectionEvents.QUERY_START.register(NetworkingLoginQueryTest::delaySimply);
	...
	private static void delaySimply(ServerLoginPacketListenerImpl handler, MinecraftServer server, PacketSender sender, ServerLoginNetworking.LoginSynchronizer synchronizer) {
		if (useLoginDelayTest) {
	...
	private static void onLoginStart(ServerLoginPacketListenerImpl networkHandler, MinecraftServer server, PacketSender sender, ServerLoginNetworking.LoginSynchronizer synchronizer) {
