...
public class LanguageTestMod {
	...
	private static void testTranslationLoaded() {
		...
		testTranslationLoaded("text.fabric_resource_loader_v0_testmod.server.lang.test0", "Test from fabric_resource_loader_v0_testmod");
		testTranslationLoaded("text.fabric_resource_loader_v0_testmod.server.lang.test1", "Test from fabric_resource_loader_v0_testmod_test1");
	}
