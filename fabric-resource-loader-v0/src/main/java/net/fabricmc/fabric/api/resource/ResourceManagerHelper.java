...
/**
 * Helper for working with {@link net.minecraft.server.packs.resources.ResourceManager} instances, and other resource loader generalities.
 */
...
public interface ResourceManagerHelper {
     ...
     * @return {@code true} if successfully registered the resource pack, else {@code false}
     */
    static boolean registerBuiltinResourcePack(ResourceLocation id, IModInfo container, ResourcePackActivationType activationType) {
        return ResourceManagerHelperImpl.registerBuiltinResourcePack(id, "resourcepacks/" + id.getPath(), container, activationType);
    }
     ...
     * @return {@code true} if successfully registered the resource pack, else {@code false}
     */
    static boolean registerBuiltinResourcePack(ResourceLocation id, IModInfo container, Component displayName, ResourcePackActivationType activationType) {
        return ResourceManagerHelperImpl.registerBuiltinResourcePack(id, "resourcepacks/" + id.getPath(), container, displayName, activationType);
    }
     ...
     * @param activationType the activation type of the resource pack
     * @return {@code true} if successfully registered the resource pack, else {@code false}
     * @deprecated Use {@link #registerBuiltinResourcePack(ResourceLocation, IModInfo, Component, ResourcePackActivationType)} instead.
     */
    @Deprecated
    static boolean registerBuiltinResourcePack(ResourceLocation id, IModInfo container, String displayName, ResourcePackActivationType activationType) {
        return ResourceManagerHelperImpl.registerBuiltinResourcePack(id, "resourcepacks/" + id.getPath(), container, Component.literal(displayName), activationType);
    }
