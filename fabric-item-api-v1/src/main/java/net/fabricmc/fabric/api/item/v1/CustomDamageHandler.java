...
/**
 * Allows an item to run custom logic when {@link ItemStack#hurtAndBreak(int, LivingEntity, Consumer)} is called.
...
public interface CustomDamageHandler {
	 ...
	 * @param breakCallback Callback when the stack reaches zero damage. See {@link ItemStack#hurtAndBreak(int, LivingEntity, Consumer)} and its callsites for more information.
