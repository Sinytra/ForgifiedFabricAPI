 ...
 * {@link net.minecraft.world.entity.LivingEntity#getEquipmentSlotForItem(ItemStack) LivingEntity.getPreferredEquipmentSlot()}.
 *
 * <p>Equipment slot providers can be set with {@link FabricItemSettings#equipmentSlot(EquipmentSlotProvider)}.
 *
 * <p>Note that items extending {@link ArmorItem} don't need to use this
 * as there's {@link ArmorItem#getEquipmentSlot()}.
 */
@FunctionalInterface
