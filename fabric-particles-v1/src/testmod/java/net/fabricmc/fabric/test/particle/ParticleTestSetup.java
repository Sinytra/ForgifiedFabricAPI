...
public final class ParticleTestSetup {
	...
	public static final RegistryObject<Block> ALWAYS_TINTED = registerBlock("always_tinted", () -> new ParticleTintTestBlock(AbstractBlock.Settings.of(Material.STONE).breakInstantly(), 0xFF00FF));
	// The dust particles of this block are only tinted when the block is broken over water.
	public static final RegistryObject<Block> TINTED_OVER_WATER = registerBlock("tinted_over_water", () -> new ParticleTintTestBlock(AbstractBlock.Settings.of(Material.STONE).breakInstantly(), 0xFFFF00));
	// The dust particles of this block are never tinted.
	public static final RegistryObject<Block> NEVER_TINTED = registerBlock("never_tinted", () -> new ParticleTintTestBlock(AbstractBlock.Settings.of(Material.STONE).breakInstantly(), 0x00FFFF));
