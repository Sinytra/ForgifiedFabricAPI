 ...
 *     This function should only be called from the "apply" phase of a {@link net.minecraft.server.packs.resources.PreparableReloadListener},
 ...
 * </ul>
 *
 * <p>At the moment, Fabric only recognizes conditions for resources loaded by subclasses of {@link net.minecraft.server.packs.resources.SimpleJsonResourceReloadListener}.
...
public final class ResourceConditions {
	private static final Map<ResourceLocation, Predicate<JsonObject>> REGISTERED_CONDITIONS = new ConcurrentHashMap<>();
	/**
	 ...
	 */
	public static void register(ResourceLocation identifier, Predicate<JsonObject> condition) {
	 ...
	 */
	@Nullable
	public static Predicate<JsonObject> get(ResourceLocation identifier) {
	 ...
	 *
	 * <p>This function should only be called from the "apply" phase of a {@link net.minecraft.server.packs.resources.PreparableReloadListener},
	 * otherwise some conditions might behave in unexpected ways.
	 *
	...
	public static boolean objectMatchesConditions(JsonObject object) {
		try {
			JsonArray conditions = GsonHelper.getAsJsonArray(object, CONDITIONS_KEY, null);
	...
	public static boolean conditionMatches(JsonObject condition) throws RuntimeException {
		ResourceLocation conditionId = new ResourceLocation(GsonHelper.getAsString(condition, CONDITION_ID_KEY));
